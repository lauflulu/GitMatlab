...
A=-beta*E-beta*E'+2*(1+beta)*speye(nx-2);  %Dirichlet (only U is modified): matrix with 1s at off-diagonals and -2s at diagonal
%A(1,1)=-1; A(nx-2,nx-2)=-1; %Neumann:
B=beta*E+beta*E'+2*(1-beta)*speye(nx-2);
